//
//  ClearedCheckpointsFilter.swift
//  illumi
//
...
final class ClearedCheckpointsFilter: CheckpointsFilter{
    ...
    func filter(){
        filteredCheckpointArray = originalCheckpointArray.filter{ $0.cleared == true }
    }
}